...
class MasterFunctions(object):
    # Constructor
    def __init__(self, deg=[True,True,True,True]):
        if deg[0]:
            self.N = qr.gaussRule1D.shape[0]
            ...
            for j, gauss in enumerate(qr.gaussRule1D):
                x = gauss[0]
                y = gauss[1]
        ...
        if deg[1]:
            ...
            for j, gauss in enumerate(qr.gaussRule2D):
                x = gauss[0]
                y = gauss[1]
